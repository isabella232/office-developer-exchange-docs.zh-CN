...
<span data-ttu-id="13743-155">当的[VSS_BACKUP_TYPE](http://msdn.microsoft.com/en-us/library/windows/desktop/aa384679%28v=vs.85%29.aspx)枚举中 VSS 设置为**VSS_BT_FULL** Exchange 编写器执行备份时，备份中包括以下组件：</span><span class="sxs-lookup"><span data-stu-id="13743-155">When the [VSS_BACKUP_TYPE](http://msdn.microsoft.com/en-us/library/windows/desktop/aa384679%28v=vs.85%29.aspx) enumeration in VSS is set to **VSS_BT_FULL** when the Exchange writer performs a backup, the following components are included in the backup:</span></span> 
...
<span data-ttu-id="13743-166">当的[VSS_BACKUP_TYPE](http://msdn.microsoft.com/en-us/library/windows/desktop/aa384679%28v=vs.85%29.aspx)枚举中 VSS 设置为**VSS_BT_COPY**时，副本备份中包含以下组件：</span><span class="sxs-lookup"><span data-stu-id="13743-166">When the [VSS_BACKUP_TYPE](http://msdn.microsoft.com/en-us/library/windows/desktop/aa384679%28v=vs.85%29.aspx) enumeration in VSS is set to **VSS_BT_COPY**, the following components are included in a copy backup:</span></span> 
...
<span data-ttu-id="13743-182">当的[VSS_BACKUP_TYPE](http://msdn.microsoft.com/en-us/library/windows/desktop/aa384679%28v=vs.85%29.aspx)枚举中 VSS 设置为**VSS_BT_INCREMENTAL**时，增量备份中包含以下组件：</span><span class="sxs-lookup"><span data-stu-id="13743-182">When the [VSS_BACKUP_TYPE](http://msdn.microsoft.com/en-us/library/windows/desktop/aa384679%28v=vs.85%29.aspx) enumeration in VSS is set to **VSS_BT_INCREMENTAL**, the following components are included in an incremental backup:</span></span> 
...
<span data-ttu-id="13743-198">当的[VSS_BACKUP_TYPE](http://msdn.microsoft.com/en-us/library/windows/desktop/aa384679%28v=vs.85%29.aspx)枚举中 VSS 设置为**VSS_BT_DIFFERENTIAL**时，差异备份中包含以下组件：</span><span class="sxs-lookup"><span data-stu-id="13743-198">When the [VSS_BACKUP_TYPE](http://msdn.microsoft.com/en-us/library/windows/desktop/aa384679%28v=vs.85%29.aspx) enumeration in VSS is set to **VSS_BT_DIFFERENTIAL**, the following components are included in a differential backup:</span></span> 
