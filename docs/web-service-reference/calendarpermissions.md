...
**CalendarPermissions**元素包含一个文件夹的日历权限数组。 在 Microsoft Exchange Server 2007 Service Pack 1 (SP1) 引入了此元素。 
...
|**元素**|**说明**|
|:-----|:-----|
|[CalendarPermission](calendarpermission.md) <br/> |定义代理用户对 "日历" 文件夹的访问权限。  <br/> |
