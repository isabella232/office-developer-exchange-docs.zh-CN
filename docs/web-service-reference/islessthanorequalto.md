...
description: IsLessThanOrEqualTo 元素表示搜索表达式，该表达式将属性与常量值或其他属性进行比较，如果第一个属性小于或等于第二个属性，则返回 true。
...
**IsLessThanOrEqualTo** 元素表示搜索表达式，该表达式将属性与常量值或其他属性进行比较，如果第一个属性小于或等于第二个属性，则返回 true。 
