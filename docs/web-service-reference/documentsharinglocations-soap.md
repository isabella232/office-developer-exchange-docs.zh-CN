...
**DocumentSharingLocations**元素包含位置和文档共享位置的元数据信息的列表。 
...
|**元素**|**说明**|
|:-----|:-----|
|[DocumentSharingLocation (SOAP)](documentsharinglocation-soap.md) <br/> |包含位置和文档共享位置的元数据。  <br/> |
   
### <a name="parent-elements"></a>父元素

|**元素**|**说明**|
|:-----|:-----|
|[DocumentSharingLocationCollectionSetting (SOAP)](documentsharinglocationcollectionsetting-soap.md) <br/> |表示用户设置，它文档共享位置和元数据的集合。  <br/> |
