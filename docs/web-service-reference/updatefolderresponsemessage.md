...
description: UpdateFolderResponseMessage 元素包含由 UpdateFolder 操作请求的 FolderChange 元素定义的更新的状态和结果。
ms.openlocfilehash: 1f86a056a6b12ff42fad6884c5de16b1412072f3
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/24/2021
ms.locfileid: "59522395"
---
# <a name="updatefolderresponsemessage"></a>UpdateFolderResponseMessage

**UpdateFolderResponseMessage 元素** 包含 [由 UpdateFolder](updatefolder-operation.md)操作请求的 [FolderChange](folderchange.md)元素定义的更新的状态和结果。 
...
|**属性**|**说明**|
|:-----|:-----|
|**ResponseClass** <br/> | 描述 [UpdateFolder 操作响应](updatefolder-operation.md) 的状态。 <br/><br/>以下值对此属性有效：  <br/><br/>- 成功  <br/>- 警告  <br/>- 错误  <br/> |
...
|**警告** <br/> | 描述未处理的请求。 如果在请求中的项目正在处理并且后续项目无法处理时发生错误，则可能会返回警告。 <br/><br/>以下是警告来源的示例：  <br/><br/>- Exchange处于脱机状态。  <br/>- Active Directory 域服务 (AD DS) 处于脱机状态。  <br/>- 移动邮箱。  <br/>- 密码已过期。  <br/>- 超出配额。  <br/> |
