...
**PostOfficeBox**元素指定邮政地址的"post office box"的部分。 
...
[PostalAddress (PersonaPostalAddressType)](postaladdress-personapostaladdresstype.md) | [值 (PersonaPostalAddressType)](value-personapostaladdresstype.md)
