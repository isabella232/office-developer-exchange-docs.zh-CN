...
**CreateFolderResponseMessage**元素包含状态和的单个结果[CreateFolder 操作](createfolder-operation.md)请求。 
...
|**属性**|**说明**|
|:-----|:-----|
|**ResponseClass** <br/> | 描述[CreateFolder 操作](createfolder-operation.md)的响应的状态。<br/><br/>下面是此属性有效值：<br/><br/>-成功  <br/>-警告  <br/>-错误  <br/> |
...
|[Folders](folders-ex15websvcsotherref.md) <br/> |包含数组的创建文件夹。  <br/> |
