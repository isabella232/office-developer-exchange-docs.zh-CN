...
**GetInboxRulesResponse**元素定义对[GetInboxRules 操作](getinboxrules-operation.md)请求的响应。 
...
|**属性**|**说明**|
|:-----|:-----|
|**ResponseClass** <br/> | 描述[GetInboxRules 操作](getinboxrules-operation.md)响应的状态。 <br/><br/>以下值对此属性有效： <br/> <br/>-成功  <br/>-警告  <br/>-错误  <br/> |
...
|[OutlookRuleBlobExists](outlookruleblobexists.md) <br/> |指示用户的邮箱中是否存在 Microsoft Outlook 规则 blob。  <br/> |
|[InboxRules](inboxrules.md) <br/> |表示用户邮箱中的规则的数组。  <br/> |
