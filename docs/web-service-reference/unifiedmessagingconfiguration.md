...
ms.locfileid: "59517495"
---
# <a name="unifiedmessagingconfiguration"></a>UnifiedMessagingConfiguration

**UnifiedMessagingConfiguration 元素** 包含统一消息服务的服务配置信息。 
...
|**元素**|**说明**|
|:-----|:-----|
|[UmEnabled](umenabled.md) <br/> |指示是否对帐户启用统一消息。 此元素是必需的。  <br/> |
|[PlayOnPhoneDialString (Exchange Web 服务) ](playonphonedialstring-exchange-web-services.md) <br/> |标识"播放时播放电话字符串。 此元素是必需的。  <br/> |
|[PlayOnPhoneEnabled](playonphoneenabled.md) <br/> |指示是否启用"在电话播放"功能。 此元素是必需的。  <br/> |
