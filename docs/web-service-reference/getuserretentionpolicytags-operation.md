...
**GetUserRetentionPolicyTags** 操作请求的以下示例显示如何获取当前用户的标记列表。 
...
以下示例显示 **GetUserRetentionPolicyTags** 操作请求的成功响应。 
