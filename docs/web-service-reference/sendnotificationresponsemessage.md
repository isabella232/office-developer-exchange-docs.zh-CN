...
**SendNotificationResponseMessage**元素包含状态和单个**SendNotification**操作请求的结果。 
...
|**属性**|**说明**|
|:-----|:-----|
|**ResponseClass** <br/> | 介绍**SendNotification**操作响应的状态。 <br/><br/>下面是此属性有效值：  <br/><br/>-成功  <br/>-警告  <br/>-错误  <br/> |
