...
**PostalAddressAttributedValue**元素指定实例及其关联的归属和邮政地址的数组。 
...
[值 (PersonaPostalAddressType)](value-personapostaladdresstype.md) | [归属 (ArrayOfValueAttributionsType)](attributions-arrayofvalueattributionstype.md)
