...
**DeleteType**元素的文本值指示如何删除会话中的项目。 以下是可能的文本值： 
  
- HardDelete-指示邮箱数据库从对话中的项目被永久删除。
    
- MoveToDeleteItems-指示对话中的项目已移动到已删除邮件文件夹。
    
- SoftDelete-指示对话中的项目是否已移动到转储程序如果转储程序已启用。
