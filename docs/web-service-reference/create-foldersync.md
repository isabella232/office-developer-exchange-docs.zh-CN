...
|[TasksFolder](tasksfolder.md) <br/> |表示邮箱中所包含的任务文件夹。  <br/> |
   
### <a name="parent-elements"></a>父元素

|**元素**|**说明**|
|:-----|:-----|
|[更改 （层次结构）](changes-hierarchy.md) <br/> |包含表示的客户端上的项目和 Exchange 服务器上的项目之间的差异的类型的更改类型序列数组。  <br/> |
