...
ms.locfileid: "59545445"
---
# <a name="deleteattachmentresponsemessage"></a>DeleteAttachmentResponseMessage

**DeleteAttachmentResponseMessage 元素** 包含单个 [DeleteAttachment](deleteattachment-operation.md)操作请求的状态和结果。 
...
|**属性**|**说明**|
|:-----|:-----|
|**ResponseClass** <br/> | 描述 [DeleteAttachment 操作响应](deleteattachment-operation.md) 的状态。<br/><br/>以下值对此属性有效：<br/><br/>- 成功  <br/>- 警告  <br/>- 错误  <br/> |
