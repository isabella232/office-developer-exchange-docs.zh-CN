...
**AddImContactToGroup** Exchange Web 服务（EWS）操作将现有的即时消息（IM）联系人添加到组中。 
  
Exchange Server 2013 中引入了此操作。
  
## <a name="using-the-addimcontacttogroup-operation"></a>使用 AddImContactToGroup 操作

**AddImContactToGroup**操作只能接受 IM 联系人。 如果要将新的 IM 联系人添加到统一联系人存储中，请使用[AddNewImContactToGroup](addnewimcontacttogroup-operation.md)操作。 
  
**AddImContactToGroup**操作可以使用下表中列出的 SOAP 标头。 
  
**表1。AddImContactToGroup 操作 SOAP 标头**
...
## <a name="addimcontacttogroup-operation-request-example-add-an-existing-im-contact-to-an-im-group"></a>AddImContactToGroup 操作请求示例：将现有 IM 联系人添加到 IM 组

以下示例的**AddImContactToGroup**操作请求显示如何添加现有 im 联系人的 im 组。 
...
## <a name="successful-addimcontacttogroup-operation-response"></a>成功的 AddImContactToGroup 操作响应

下面的示例演示对**AddImContactToGroup**操作请求的成功响应。 
...
下面的示例演示对**AddImContactToGroup**操作请求的错误响应。 当尝试添加不是 IM 联系人的联系人时，将发生以下错误响应。 
