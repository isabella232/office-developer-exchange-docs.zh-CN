...
**EcpUrl 发布**元素指定可以结合使用[EcpUrl (POX)](ecpurl-pox.md)元素的值生成一个 URL，可用于访问日历发布已启用邮件的用户设置的部分 URL。 
...
文本值表示可以结合使用[EcpUrl (POX)](ecpurl-pox.md)元素的值生成一个 URL，可用于访问用户的日历发布设置的部分 URL。 
  
## <a name="remarks"></a>备注

**EcpUrl 发布**元素是**协议**元素的可选子元素。 
