...
ms.locfileid: "59536306"
---
# <a name="createmanagedfolderresponsemessage"></a>CreateManagedFolderResponseMessage

**CreateManagedFolderResponseMessage 元素** 包含单个 [CreateManagedFolder](createmanagedfolder-operation.md)操作请求的状态和结果。 
...
|**属性**|**说明**|
|:-----|:-----|
|**ResponseClass** <br/> | 描述 [CreateManagedFolder](createmanagedfolder-operation.md) 操作响应的状态。<br/><br/>以下值对此属性有效：<br/><br/>- 成功  <br/>- 警告  <br/>- 错误  <br/> |
...
|[Folders](folders-ex15websvcsotherref.md) <br/> |包含已创建的托管文件夹的数组。  <br/> |
