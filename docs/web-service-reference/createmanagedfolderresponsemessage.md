...
**CreateManagedFolderResponseMessage**元素包含状态和的单个结果[CreateManagedFolder 操作](createmanagedfolder-operation.md)请求。 
...
|**属性**|**说明**|
|:-----|:-----|
|**ResponseClass** <br/> | 描述[CreateManagedFolder 操作](createmanagedfolder-operation.md)的响应的状态。<br/><br/>下面是此属性有效值：<br/><br/>-成功  <br/>-警告  <br/>-错误  <br/> |
...
|[Folders](folders-ex15websvcsotherref.md) <br/> |包含创建托管文件夹的数组。  <br/> |
