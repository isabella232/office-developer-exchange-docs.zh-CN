...
**CreateManagedFolderResponseMessage**元素包含单个[CreateManagedFolder 操作](createmanagedfolder-operation.md)请求的状态和结果。 
...
|**属性**|**说明**|
|:-----|:-----|
|**ResponseClass** <br/> | 描述[CreateManagedFolder 操作](createmanagedfolder-operation.md)响应的状态。<br/><br/>以下值对此属性有效：<br/><br/>-成功  <br/>-警告  <br/>-错误  <br/> |
...
|[Folders](folders-ex15websvcsotherref.md) <br/> |包含创建的托管文件夹的数组。  <br/> |
