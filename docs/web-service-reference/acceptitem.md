...
|[ProposedStart](proposedstart.md) <br/> |指定会议建议的开始的时间。  <br/> |
|[ProposedEnd](proposedend.md) <br/> |指定会议建议的结束时间。  <br/> |
...
描述此元素的架构位于安装了客户端访问服务器角色的 Exchange 服务器 EWS 目录中。
