...
|[InternetMessageHeaders](internetmessageheaders.md) <br/> |代表 headers 集合中给定邮件头的 Internet 邮件头名称。  <br/> |
...
|[ProposedStart](proposedstart.md) <br/> |指定建议的会议开始时间。  <br/> |
|[ProposedEnd](proposedend.md) <br/> |指定建议的会议结束时间。  <br/> |
...
描述此元素的架构位于安装了客户端访问服务器角色的 Exchange 服务器的 EWS 目录中。
