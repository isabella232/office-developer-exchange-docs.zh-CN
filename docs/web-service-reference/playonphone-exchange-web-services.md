...
**PlayOnPhone**元素表示为 read item 电话上的请求。 
...
|**元素**|**说明**|
|:-----|:-----|
|[ItemId](itemid.md) <br/> |表示一个项目以在电话上播放的标识符。 此元素是必需的。  <br/> |
|[DialString （Exchange Web 服务）](dialstring-exchange-web-services.md) <br/> |代表调用播放项目通过电话的电话号码的拨号字符串。 此元素是必需的。  <br/> |
