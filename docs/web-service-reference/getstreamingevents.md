...
**GetStreamingEvents**元素均表示客户端用于从服务器请求流通知的操作。 
...
|**元素**|**说明**|
|:-----|:-----|
|[SubscriptionId (GetStreamingEvents)](subscriptionid-getstreamingevents.md) <br/> |表示查询事件的订阅标识符。  <br/> |
|[ConnectionTimeout](connectiontimeout.md) <br/> |代表要保持连接处于打开状态的分钟数。  <br/> |
