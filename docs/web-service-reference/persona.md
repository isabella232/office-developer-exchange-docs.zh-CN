...
---
# <a name="persona"></a><span data-ttu-id="5c47a-103">角色</span><span class="sxs-lookup"><span data-stu-id="5c47a-103">Persona</span></span>

<span data-ttu-id="5c47a-104">**个人**元素指定一的组个人**GetPersona**请求返回的数据。</span><span class="sxs-lookup"><span data-stu-id="5c47a-104">The **Persona** element specifies a set of persona data returned by a **GetPersona** request.</span></span> 
