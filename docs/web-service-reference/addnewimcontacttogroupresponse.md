...
**AddNewImContactToGroupResponse**元素定义**AddNewImContactToGroup**请求的响应。 
...
[MessageText](messagetext.md) | [ResponseCode](responsecode.md) | [DescriptiveLinkKey](descriptivelinkkey.md) | [MessageXml](messagexml.md) | [角色](persona.md)
