...
**EmptyFolderResponseMessage**元素包含单个[EmptyFolder](emptyfolder.md)请求的状态和结果。 
...
|**属性**|**说明**|
|:-----|:-----|
|**ResponseClass** <br/> | 描述[EmptyFolder 操作](emptyfolder-operation.md)响应的状态。<br/><br/>以下值对此属性有效：<br/><br/>-成功  <br/>-警告  <br/>-错误  <br/> |
