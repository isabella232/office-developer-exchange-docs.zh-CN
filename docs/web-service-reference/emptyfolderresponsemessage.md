...
ms.locfileid: "59514702"
---
# <a name="emptyfolderresponsemessage"></a>EmptyFolderResponseMessage

**EmptyFolderResponseMessage 元素** 包含单个 [EmptyFolder](emptyfolder.md)请求的状态和结果。 
...
|**属性**|**说明**|
|:-----|:-----|
|**ResponseClass** <br/> | 描述 [EmptyFolder 操作响应](emptyfolder-operation.md) 的状态。<br/><br/>以下值对此属性有效：<br/><br/>- 成功  <br/>- 警告  <br/>- 错误  <br/> |
