...
**GetSharingMetadataResponseMessage** 元素包含单个 [GetSharingMetadata](getsharingmetadata-operation.md)操作请求的状态和结果。 
...
|[EncryptedSharedFolderDataCollection](encryptedsharedfolderdatacollection.md) <br/> |包含客户端可用于授权与其他客户端共享其日历或联系人数据的数据结构的集合。  <br/> |
