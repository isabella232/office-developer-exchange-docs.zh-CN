...
ms.locfileid: "59509782"
---
# <a name="getserviceconfigurationresponse"></a>GetServiceConfigurationResponse

**GetServiceConfigurationResponse** 元素定义对 GetServiceConfiguration 请求的响应。 
...
|[ResponseMessages (ArrayOfServiceConfigurationResponseMessageType)](responsemessages-arrayofserviceconfigurationresponsemessagetype.md) <br/> |包含服务配置响应消息数组。  <br/> |
