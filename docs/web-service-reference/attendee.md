...
|[ResponseType](responsetype.md) <br/> |代表收到会议的收件人响应的类型。 此属性才与会议组织者的日历项目相关。  <br/> |
|[LastResponseTime](lastresponsetime.md) <br/> |表示的日期和最新收到的响应的时间。  <br/> |
