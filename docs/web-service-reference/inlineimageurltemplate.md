...
**InlineImageUrlTemplate**元素的内嵌图像 URL 中指定的模板。 
...
|**元素**|**说明**|
|:-----|:-----|
|[ItemShape](itemshape.md) <br/> |标识要[GetItem 操作](getitem-operation.md)、 [FindItem 操作](finditem-operation.md)或[SyncFolderItems 操作](syncfolderitems-operation.md)的响应中返回属性的集。  <br/> |
   
## <a name="text-value"></a>文本值

**InlineImageUrlTemplate**元素的文本值的内嵌图像 URL 中指定的模板。 
