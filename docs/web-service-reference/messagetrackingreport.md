...
---
# <a name="messagetrackingreport"></a>Search-messagetrackingreport

**Search-messagetrackingreport**元素包含[GetMessageTrackingReport 操作](getmessagetrackingreport-operation.md)中返回的单个邮件。
...
|[SubmitTime](submittime.md) <br/> |包含电子邮件提交日期的时间。  <br/> |
