...
ms.locfileid: "59536540"
---
# <a name="createattachmentresponsemessage"></a>CreateAttachmentResponseMessage

**CreateAttachmentResponseMessage 元素** 包含单个 [CreateAttachment](createattachment-operation.md)操作请求的状态和结果。 
...
|**属性**|**说明**|
|:-----|:-----|
|**ResponseClass** <br/> | 描述 [CreateAttachment](createattachment-operation.md) 操作响应的状态。 <br/><br/>以下值对此属性有效：<br/><br/>- 成功  <br/>- 警告  <br/>- 错误  <br/> |
...
> [!NOTE]
> 如果在一次往返中向某个项目附加了多个附件，则最后一个响应邮件中的 **RootItemChangeKey** 属性是代表包含附件的项目的新更改键的属性。 
