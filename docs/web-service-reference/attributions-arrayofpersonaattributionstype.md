...
**归属**元素指定一个或多个联系人或聚合到相关联的角色的 Active Directory 收件人的归属信息的数组。 
...
|**元素**|**说明**|
|:-----|:-----|
|[归属 (PersonaAttributionType)](attribution-personaattributiontype.md) <br/> |数组**PersonaType**元素的属性中指定的实例。  <br/> |
