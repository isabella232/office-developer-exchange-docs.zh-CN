...
**CalendarFolderPermissionLevel**元素包含默认日历文件夹的权限。 Microsoft Exchange Server 2007 Service Pack 1 (SP1) 中引入了此元素。 
...
|**权限级别**|**说明**|
|:-----|:-----|
|无  <br/> |代理用户对日历文件夹具有任何访问权限。  <br/> |
|Reviewer  <br/> |委派用户可以读取日历文件夹中的项目。  <br/> |
|作者  <br/> |委派用户可以读取和日历文件夹中创建项目。  <br/> |
|Editor  <br/> |委派用户可以读取、 创建和修改日历文件夹中的项目。  <br/> |
|自定义  <br/> |代理用户对日历文件夹具有自定义访问权限。  <br/> |
