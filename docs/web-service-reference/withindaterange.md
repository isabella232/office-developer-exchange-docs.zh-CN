...
**WithinDateRange**元素指定在其中传入消息必须已收到的条件或例外的顺序应用中的日期范围。 
...
|**元素**|**说明**|
|:-----|:-----|
|[开始日期时间](startdatetime.md) <br/> |指定时间段的规则，并指示的规则条件得到满足后此值。  <br/> |
|[EndDateTime](enddatetime.md) <br/> |指定时间段的规则，并指示的规则条件得到满足此值之前。  <br/> |
