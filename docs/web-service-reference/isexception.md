...
**IsException**元素指示定期日历项目的实例是否已从主控形状更改。 
...
|**元素**|**说明**|
|:-----|:-----|
|[CalendarEventDetails](calendareventdetails.md) <br/> |提供有关日历事件的其他信息。  <br/> 以下是此元素的 XPath 2.0 表达式：  <br/>  `/GetUserAvailabilityResponse/FreeBusyResponseArray/FreeBusyResponse/FreeBusyView/CalendarEventArray/CalendarEvent[i]/CalendarEventDetails` <br/> |
