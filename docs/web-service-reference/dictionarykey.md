...
**DictionaryKey**元素指定 dictionary 属性的字典键。 
...
|**元素**|**说明**|
|:-----|:-----|
|[类型（UserConfiguration）](type-userconfiguration.md) <br/> | 指定 dictionary 对象类型。<br/><br/>键入的值可以是下列字符串值之一：<br/><br/>-DateTime  <br/>-布尔值  <br/>-Byte  <br/>-String  <br/>- Integer32  <br/>- UnsignedInteger32  <br/>- Integer64  <br/>- UnsignedInteger64  <br/>- StringArray  <br/>- ByteArray  <br/> |
