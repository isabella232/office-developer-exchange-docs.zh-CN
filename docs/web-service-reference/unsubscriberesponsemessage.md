...
description: UnsubscribeResponseMessage 元素包含单个 Unsubscribe 操作请求的状态和结果。
...
**UnsubscribeResponseMessage 元素** 包含单个 Unsubscribe 操作请求 [的状态和](unsubscribe-operation.md)结果。 
...
|**属性**|**说明**|
|:-----|:-----|
|**ResponseClass** <br/> | 描述取消订阅操作 [响应](unsubscribe-operation.md) 的状态。 <br/><br/>以下值对此属性有效： <br/> <br/>- 成功  <br/>- 警告  <br/>- 错误  <br/> |
