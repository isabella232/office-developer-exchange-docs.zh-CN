...
**SuggestionDayResult**元素表示包含建议会议时间的一天。 
...
|[DayQuality](dayquality.md) <br/> |表示包含质量建议会议时间的日的质量。  <br/> |
...
|**元素**|**说明**|
|:-----|:-----|
|[SuggestionDayResultArray](suggestiondayresultarray.md) <br/> |包含按日期组织的会议建议的数组。  <br/> 下面是此元素的 XPath 表达式：   <br/>  `/GetUserAvailabilityResponse/SuggestionsResponse/SuggestionDayResultArray` <br/> |
