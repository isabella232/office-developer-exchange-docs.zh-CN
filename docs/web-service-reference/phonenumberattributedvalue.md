...
**PhoneNumberAttributedValue**元素指定实例及其关联的归属和数组的电话号码。 
...
[值 (PersonaPhoneNumberType)](value-personaphonenumbertype.md) | [归属 (ArrayOfValueAttributionsType)](attributions-arrayofvalueattributionstype.md)
