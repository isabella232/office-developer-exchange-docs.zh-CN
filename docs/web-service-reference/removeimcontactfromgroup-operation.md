...
**RemoveImContactFromGroup** 操作采用两个参数：联系人项目标识符和相应的即时消息 (IM) 从中删除联系人的组。 
...
**RemoveImContactFromGroup** 操作请求的以下示例显示如何从 IM 组中删除 IM 联系人。 
...
以下示例显示对 **RemoveImContactFromGroup** 操作请求的成功响应。 
...
以下示例显示对 **RemoveImContactFromGroup** 操作请求的错误响应。 当尝试删除 IM 组中不存在的联系人项目时，将发生以下错误响应。 
