...
description: Emails3 元素指定 EmailAddressAttributedValue 值的数组及其关联人物的源属性的标识符。
ms.openlocfilehash: bab9c8da1da8d2e72b0bec5949696f3d43587959
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/24/2021
ms.locfileid: "59533867"
---
# <a name="emails3"></a>Emails3

**Emails3** 元素指定 **EmailAddressAttributedValue** 值的数组及其关联人物的源属性的标识符。 
