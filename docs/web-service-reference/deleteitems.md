...
description: DeleteItems 元素指示用户有权删除文件夹中的哪些项目。 在 Microsoft Exchange Server 2007 Service Pack 1 (SP1) 引入了此元素。
ms.openlocfilehash: d41e44c3cc0996ab5933eafaf1087cf30d7944a3
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/24/2021
ms.locfileid: "59546670"
---
# <a name="deleteitems"></a>DeleteItems

**DeleteItems** 元素指示用户有权删除文件夹中的哪些项目。 在 Microsoft Exchange Server 2007 Service Pack 1 (SP1) 引入了此元素。 
...
|**值**|**说明**|
|:-----|:-----|
|无  <br/> |指示用户无权删除文件夹中的项目。  <br/> |
|拥有  <br/> |指示用户有权删除文件夹中用户拥有的项目。  <br/> |
