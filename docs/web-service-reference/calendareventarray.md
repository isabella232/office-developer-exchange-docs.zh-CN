...
**CalendarEventArray**元素包含一组唯一的日历项目事件表示所请求的用户的可用性。 
...
|**元素**|**说明**|
|:-----|:-----|
|[CalendarEvent](calendarevent.md) <br/> |代表独特的日历项匹配项。  <br/> |
...
提供此元素的详细程度取决于所请求者授予的权限。 [FreeBusyViewType](freebusyviewtype.md)元素设置为**FreeBusy**、 **FreeBusyMerged**、 **Detailed**或**DetailedMerged**时包含此元素。 如果没有日历项目存在于请求的时间窗口中，此元素不包括任何子元素。 
