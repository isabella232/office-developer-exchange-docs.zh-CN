...
**TentativelyAcceptItem**元素表示对会议请求的暂定答复。 
...
|[Sensitivity](sensitivity.md) <br/> |标识项的敏感度。  <br/> |
|[Body](body.md) <br/> |表示邮件的实际正文内容。  <br/> |
|[附件](attachments-ex15websvcsotherref.md) <br/> |包含附加到 Exchange 存储中的项目的项目或文件。  <br/> |
|[Message](internetmessageheaders.md) <br/> |表示标头集合中给定标头的 Internet 邮件头名称。  <br/> |
...
|[ProposedStart](proposedstart.md) <br/> |指定会议请求的建议开始时间。  <br/> |
|[ProposedEnd](proposedend.md) <br/> |指定会议请求的建议结束时间。  <br/> |
