...
ms.locfileid: "59542454"
---
# <a name="deletefolderresponsemessage"></a>DeleteFolderResponseMessage

**DeleteFolderResponseMessage 元素** 包含单个 [DeleteFolder](deletefolder-operation.md)操作请求的状态和结果。 
...
|**属性**|**说明**|
|:-----|:-----|
|**ResponseClass** <br/> | 描述 [DeleteFolder 操作响应](deletefolder-operation.md) 的状态。<br/><br/>以下值对此属性有效：<br/><br/>- 成功  <br/>- 警告  <br/>- 错误  <br/> |
