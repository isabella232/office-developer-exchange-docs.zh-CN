...
**CreateUserConfigurationResponseMessage**元素包含单个**CreateUserConfiguration**请求的状态和结果。 
...
|**Error** <br/> | 介绍无法满足的请求。<br/><br/> 以下是错误源的示例：  <br/><br/>-属性或元素无效。  <br/>-超出范围的属性或元素。  <br/>-未知标记。  <br/>-属性或元素在上下文中无效。  <br/>-任何客户端进行未经授权的访问尝试。  <br/>-响应有效客户端调用的服务器端故障。<br/><br/>  有关错误的信息可以在[ResponseCode](responsecode.md)和[MessageText](messagetext.md)元素中找到。  <br/> |
