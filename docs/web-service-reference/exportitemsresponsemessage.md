...
ms.locfileid: "59517082"
---
# <a name="exportitemsresponsemessage"></a>ExportItemsResponseMessage

**ExportItemsResponseMessage 元素** 包含导出单个邮箱项目的请求的状态和结果。 
...
|[ItemId](itemid.md) <br/> |包含导出项的项目标识符。  <br/> |
|[Data (base64Binary)](data-base64binary.md) <br/> |包含导出项的内容。  <br/> |
