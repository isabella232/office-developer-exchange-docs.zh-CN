...
**GetAppMarketplaceUrl**操作中检索应用程序市场的客户端可以访问获取要在邮箱中安装的应用程序的 URL。 
  
Exchange Server 2013 中引入了此操作。
  
## <a name="using-the-getappmarketplaceurl-operation"></a>使用 GetAppMarketplaceUrl 操作

**GetAppMarketplaceUrl**操作不采用任何参数，以请求的市场客户端可以在其中安装应用程序的 URL。 响应将包含指向应用程序市场的 URL。 
...
## <a name="getappmarketplaceurl-operation-request-example-get-the-app-marketplace-url-for-a-mailbox"></a>GetAppMarketplaceUrl 操作请求示例： 获取对邮箱的应用程序的市场 URL

**GetAppMarketplaceUrl**操作请求的下面的示例演示如何获取对邮箱的应用程序的市场 URL。 
...
## <a name="successful-getappmarketplaceurl-operation-response"></a>成功 GetAppMarketplaceUrl 操作响应

下面的示例演示对**GetAppMarketplaceUrl**操作请求的邮箱中获取应用程序的市场 URL 的成功响应。 
  
> [!NOTE]
> 已更改的应用程序的市场 URL 以保留可读性。 
...
此操作返回的错误也与不正确的服务配置相关，或泛型 EWS 错误。 通用到 EWS 且特定于此操作的错误代码，请参阅[ResponseCode](responsecode.md)。 
  
下面的示例演示时未配置外部 Exchange 控制面板 (ECP)，则返回错误响应。
