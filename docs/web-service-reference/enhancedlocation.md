...
**EnhancedLocation**元素指定如姓名、 地址和可选注释有关位置的位置信息。 
...
|[批注](annotation.md) <br/> |包含由用户添加的可选说明。  <br/> |
|[PostalAddress (PersonaPostalAddressType)](postaladdress-personapostaladdresstype.md) <br/> |指定个人的邮政地址。  <br/> |
