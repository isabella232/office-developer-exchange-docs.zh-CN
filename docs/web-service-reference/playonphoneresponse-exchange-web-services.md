...
|**错误** <br/> | 描述无法实现的请求。 <br/><br/>以下是错误源的示例：  <br/><br/>- 属性或元素无效。  <br/>- 区域外的属性或元素  <br/>- 未知标记。  <br/>- 在上下文中无效属性或元素。  <br/>- 任何客户端的未经授权访问尝试。  <br/>- 响应有效的客户端调用的服务器端故障。  <br/><br/>  有关错误的信息，请参阅 [ResponseCode](responsecode.md) 和 [MessageText](messagetext.md) 元素主题。  <br/> |
...
|[PhoneCallId](phonecallid.md) <br/> |指定电话呼叫标识符。  <br/> |
