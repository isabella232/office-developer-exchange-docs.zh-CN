...
**GetServiceConfiguration**操作获取的服务的指定类型的配置信息。 此操作可返回的统一消息、 保护规则和邮件提示服务配置设置。 
  
## <a name="getserviceconfiguration-request-example"></a>GetServiceConfiguration 请求示例

### <a name="description"></a>说明

**GetServiceConfiguration**请求的下面的示例演示如何以形成一个请求以获取统一消息服务的配置信息。 
...
下面的示例演示对**GetServiceConfiguration**请求成功响应。 
...
下面的示例演示对**GetServiceConfiguration**请求错误响应。 不正确配置名称导致出现此错误。 
