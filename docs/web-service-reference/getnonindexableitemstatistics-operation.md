...
**GetNonIndexableItemStatistics**操作中检索邮箱中无法编制索引的项的计数。 
  
Exchange Server 2013 中引入了此操作。
  
## <a name="using-the-getnonindexableitemstatistics-operation"></a>使用 GetNonIndexableItemStatistics 操作

**GetNonIndexableItemStatistics**操作计数不能编制索引的邮箱项目。 在发现搜索在搜索过程中，不搜索无法编入索引的项目。 
...
## <a name="getnonindexableitemstatistics-operation-request-example-get-the-count-of-items-that-cannot-be-indexed-in-a-mailbox"></a>GetNonIndexableItemStatistics 操作请求示例： 获取邮箱中无法编制索引的项目

**GetNonIndexableItemStatistics**操作请求的下面的示例演示如何请求的邮箱中无法编制索引的项计数。 
...
## <a name="successful-getnonindexableitemstatistics-operation-response"></a>成功 GetNonIndexableItemStatistics 操作响应

下面的示例演示对**GetNonIndexableItemStatistics**操作请求以获取邮箱中无法编制索引的项目的成功响应。 
...
下面的示例演示对**GetNonIndexableItemStatistics**操作请求错误响应。 这是对获取无法从多个邮箱编制索引的项目计数的请求的响应。 
