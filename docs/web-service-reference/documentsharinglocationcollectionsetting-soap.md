...
**DocumentSharingLocationCollectionSetting**元素表示用户设置，它文档共享位置和元数据的集合。 
...
|**元素**|**说明**|
|:-----|:-----|
|[DocumentSharingLocations (SOAP)](documentsharinglocations-soap.md) <br/> |表示的位置和文档共享位置的列表的元数据。  <br/> |
   
### <a name="parent-elements"></a>父元素

|**元素**|**说明**|
|:-----|:-----|
|[用户设置 (SOAP)](usersettings-soap.md) <br/> |代表用户设置的集合。  <br/> |
