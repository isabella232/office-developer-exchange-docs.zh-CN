...
---
# <a name="setplayonphonedialstringresponse-um-web-service"></a>SetPlayOnPhoneDialStringResponse （UM web 服务）

**SetPlayOnPhoneDialStringResponse**元素定义对[SETPLAYONPHONEDIALSTRING 操作（UM web 服务）](setplayonphonedialstring-operation-um-web-service.md)请求的响应。 
